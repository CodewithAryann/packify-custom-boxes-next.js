  ...
  return (
    <section className="max-w-6xl mx-auto px-6 py-8">
      <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8 md:p-12">
        {/* Main Heading */}
        <h1 className="text-4xl md:text-5xl font-extrabold text-gray-900 mb-6 bg-gradient-to-r from-gray-800 via-gray-900 to-gray-800 bg-clip-text text-transparent">
          {seoContent.h1}
        </h1>
